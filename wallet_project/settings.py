...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-cno!!spmn9(hpbn7=^l^ykt47#u@205^8=akn9e*zem1m%rxui')
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('DB_USER', 'walletuser'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'walletpassword'),
